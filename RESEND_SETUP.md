...
INQUIRY_TO_EMAIL=sales@sendoragift.com
...
6. Check the inbox and spam folder for `sales@sendoragift.com`.
...
`inquiry@sendoragift.com` is used as the verified sender address. It does not necessarily need to exist as a real receiving mailbox, depending on Resend domain verification rules. The actual inquiry recipient is `sales@sendoragift.com`.
